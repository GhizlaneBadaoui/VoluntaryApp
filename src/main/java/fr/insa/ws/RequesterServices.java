...
public class RequesterServices {
    ...
    public Requester subscribe(@WebParam(name = "name") String name, @WebParam(name = "mail") String mail, @WebParam(name = "phoneNumber") String phoneNumber, @WebParam(name = "address")String address) throws SQLException {
    ...
    public String getRequester(@WebParam(name = "mail") String mail) throws SQLException {
